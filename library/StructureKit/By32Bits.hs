...
adjust cont key =
  mapCoercible
    (flip By6Bits.adjust (KeyOps.toIndexOfLevel1 key)
      (flip By6Bits.adjust (KeyOps.toIndexOfLevel2 key)
        (flip By6Bits.adjust (KeyOps.toIndexOfLevel3 key)
          (flip By6Bits.adjust (KeyOps.toIndexOfLevel4 key)
            (flip By8Bits.adjust (KeyOps.toIndexOfLevel5 key)
              cont)))))
